...
public class MyIndexWriter {
	...
	public MyIndexWriter( String dataType ) throws IOException {
		...
		if (dataType.equals("education")) {
			directory = FSDirectory.open(Paths.get(Classes.Path.IndexEduDir));  
		} 
		else if (dataType.equals("job")){
			directory = FSDirectory.open(Paths.get(Classes.Path.IndexJobDir));
		}
		else if (dataType.equals("skill")){
			directory = FSDirectory.open(Paths.get(Classes.Path.IndexSkillDir));
		}
		else {
			directory = FSDirectory.open(Paths.get(Classes.Path.IndexGenerDir));
		}
